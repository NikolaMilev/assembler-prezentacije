...
\section{Instrukcije}
	...
	\begin{itemize}
		...
		\item Šiftovanje (pomeranje) u levo: $shl$ $op1$, $op2$ -- pomera prvi argument za broj mesta koji je sadržan u drugom argumentu
		\item Šiftovanje (pomeranje) u desno:
			\begin{itemize}
				\item Logičko: $shr$ $op1$, $op2$
				\item Aritmetičko: $sar$ $op1$, $op2$
			\end{itemize}
